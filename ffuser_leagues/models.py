...
class League(models.Model):
  platform = models.CharField(Platform, on_delete= models.CASCADE)
  ...
  previous_league_id = models.CharField(default=200)
...
class LeagueMatchup(models.Model):
  ...
  point_totals = models.IntegerField(max_length=200)
...
class Transaction(models.Model):
  ...
  roster_ids = models.IntegerField(max_length= 100)
